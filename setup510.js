...
        {param: process.argv[4],
        ...
        {param: process.argv[12],
        value: 'NODE_ENV='+process.argv[13]
        },
        {param: process.argv[14],
        value: 'CC_USER='+process.argv[15]
        },
        {param: process.argv[16],
        value: 'CC_PASSWORD='+process.argv[17]
        },
        {param: process.argv[18],
        value: 'CC_SSL='+process.argv[19]
        },
        {param: process.argv[20],
        value: 'PORT='+process.argv[21]
        },
        {param: process.argv[22],
        value: 'DISABLED='+process.argv[23]
        }];
...
console.log('parma array '+process.argv[3]);
		  ...
		  database : process.argv[7]
   		 ...
   		 connection.connect(function(err) {
				...
				  } else {
			        ...
			        var sq2B = "(InvitationListID int(11) NOT NULL, BadgeNumber varchar(20) NOT NULL, LastName varchar(60), FirstName varchar(30), EmailAddress varchar(30), NotificationNumber bigint(20) unsigned NOT NULL, NumberFormat varchar(40), UpdateTime varchar(64), "
			       ...
			       var _sql3 = "ALTER TABLE events MODIFY EventID INT(11) AUTO_INCREMENT PRIMARY KEY;"
				        connection.query(_sql3, function(err, result3) {
				          	if(!err){console.log('EventID field in Events table has been modified.')}
				          connection.end()
				          });
